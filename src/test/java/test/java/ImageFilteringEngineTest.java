...
public class ImageFilteringEngineTest {
    ...
    private IImageFilteringEngine engine = new MyImageFilteringEngine(); // Replace 'MyImageFilteringEngine' with your actual implementation
    ...
    public void testGrayLevelFilter() throws IOException {
        ...
        BufferedImage actualOutputImage = engine.applyFilter(inputImage, new GrayLevelFilter());
